 ...
 <section id="content">
        ...
        <div class="block">
            <div class="inner width-2">
                <div class="box-login">
                    <div class="head">
                        <h2 class="heading-title">File/Folder Management</h2><em> <h3>Add content to the File</h3></em>
</div>
                    <div class="box-form">
...
<p><textarea name="comment" placeholder="Content of the File" required class="text-input focus" rows="8" style="height:200px;">
</textarea></p>
<p><input type="submit" name="write" value="Write" class="button large bold"></p>
</form></div>
                </div>
            </div>
        </div>
